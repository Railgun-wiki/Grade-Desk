...
The module owns no data. It reads typed records from the grade repository and uses in-memory UI state only for search text, active view, and selected course.
