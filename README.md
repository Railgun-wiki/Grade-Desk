...
Grade Desk 是一个专为中山大学 (SYSU) 学生设计的**本地优先 (Local-first)、隐私安全**的成绩管理、绩点分析与快照归档桌面客户端。
...
- **pnpm** (唯一指定前端依赖管理器)
- **Rust 工具链** (Rustc 1.75+)
- 当前平台特有的编译依赖（参见 [开发者文档](docs/implementation-plan.md#3-本地开发环境搭建)）
...
- ⚙️ **[开发者核心文档 (Developer Guide)](docs/implementation-plan.md)**：包含整体系统架构设计、详细目录介绍、本地环境配制、性能限制及安全原则。
...
本项目属于中山大学学子本地成绩档案管理辅助工具，具体协议请参见 LICENSE。数据及知识产权归项目开发者和贡献者所有。
